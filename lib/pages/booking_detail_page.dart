            ...
            child: Column(
              children: [
                ...
                _card([
                  ...
                  _row(
                    'Created',
                    '${_date(data['createdAt'] as Timestamp?)}\n${_time(data['createdAt'] as Timestamp?)}',
                  ),
                ]),
                const SizedBox(height: 16),
                Row(
                ...
                if (petData != null) ...[
                  ...
                  _card([
                    ...
                    _detail(
                      ...
                      'Preferences',
                      petData!['preferences']?.toString() ?? 'N/A',
