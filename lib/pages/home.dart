      ...
      child: Form(
        ...
        child: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Text('Create Package', style: Theme.of(context).textTheme.titleLarge),
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'Price label (e.g. "50 CHF")', border: OutlineInputBorder()),
            ...
            TextFormField(
              ...
              validator: (v)=> _linesToServices(v??'').isEmpty ? 'Add at least one service' : null,
            ),
            const SizedBox(height: 12),
